...
const Mappp = () => {
  return (
    <div className="container mx-auto lg:flex gap-20 my-20">
      ...
      <div className="w-[90%] lg:w-[40%] mx-auto lg:mx-0">
        <h1 className="text-2xl md:text-3xl font-bold mb-6">EXPLORE OUR LOCATION</h1>
        ...
        <div className="flex gap-2 items-center text-[22px] md:text-2xl my-4">
        <PiAirplaneTiltFill className="text-red-400"/>
        <p>22 minutes taxi to airport <span className="text-sm">5 Km</span></p>

        </div>
        <div className="flex gap-2 items-center text-[22px] md:text-2xl my-2">
